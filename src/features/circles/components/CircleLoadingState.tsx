...
export function CircleLoadingState() {
  return (
    <GlowPage withBottomNav>
      <main className="overflow-y-auto pt-safe" aria-busy="true">
        <GlowContainer size="md" as="div" className="pb-10">
          <div className="pb-6 pt-8">
            <p className="glow-gradient-text text-[1.75rem] font-bold tracking-tight">
              Glow
            </p>
          </div>
          ...
          <GlowCard padding="md" className="border-white/[0.06]">
            ...
            <div
              className="mt-5 h-7 w-2/3 animate-pulse rounded-xl bg-white/[0.06] motion-reduce:animate-none"
              aria-hidden="true"
            />
            <div
